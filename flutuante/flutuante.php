...
<?php if (isset($infoSistema->whatsapp_flutuante) && !empty($infoSistema->whatsapp_flutuante)) { ?>
    <div>
        <a href="https://api.whatsapp.com/send?phone=55<?php echo $infoSistema->whatsapp_flutuante; ?>&text=Olá,%20gostaria%20de%20agendar%20um%20exame%20com%20a%20CIR!"
            style="bottom:105px" target="_blank" class="btn-floating-whats btn-large btn-success whatsapp">
    ...
    <div class="fixed-action-btn click-to-toggle ">
        <div class="hidden fixed-action-btn1" id="mostraLigue">
            <a href="tel:<?php echo str_replace(")", "", str_replace("(", "", $infoSistema->telefone_flutuante)); ?>"
                class="btn-floating1 btn-info">
                <!-- <img  src="images/telephone1.png" width="300" /> -->
                <div class="telefone"><i class="fa fa-phone"></i>
                    <?php echo $infoSistema->telefone_flutuante; ?><span>Ligue
                        Agora</span>
                </div>
            </a>
        </div>
        <a href="<?php echo $infoSistema->telefone_flutuante; ?>" style="bottom:80px" onclick="mostra()"
...
<?php if (isset($infoSistema->popup_ativo) && ($infoSistema->popup_ativo == 'Sim')) { ?>
    <div id="popupModal" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="popupModalLabel"
        style="display: block">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <h4 class="title">
                                <?php echo strip_tags($infoSistema->popup_titulo); ?>
                            </h4>
                            <p>
                                <?php echo strip_tags($infoSistema->popup_texto); ?>
                            </p>
