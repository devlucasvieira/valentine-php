	...
	class Cidades
	{
		...
		function selectCidades($uf = "", $id_estado = "", $nomeCampo = 'id_cidade', $selecionado = '', $campoLabel = 'nome', $style = "", $class = 'form-control', $desc_primeira_opcao = '', $disabled = '')
		{
			...
			<select name="<?php echo $nomeCampo; ?>" id="<?php echo $nomeCampo; ?>" class="<?php echo $class; ?>"
				style=" <?php echo $style; ?>" <?php if ($disabled == 'S') {
					  echo "disabled";
				  } ?>>
				<option value="">
					<?php echo $desc_primeira_opcao; ?>
				</option>
				<?php
				foreach ($cidades as $cidade) {
					?>
					<option value="<?php echo $cidade->id ?>" <?php if (isset($selecionado) && $cidade->id == $selecionado) {
						  echo "selected";
					  } ?>><?php echo $cidade->$campoLabel; ?></option>
				<?php
				}
				?>
			</select>
