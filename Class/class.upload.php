    ...
    function process($server_path = null)
    {
        ...
        if ($this->processed) {
            ...
            if ($this->no_script) {
                ...
                if (
                    (((substr($this->file_src_mime, 0, 5) == 'text/' && $this->file_src_mime != 'text/rtf') || strpos($this->file_src_mime, 'javascript') !== false) && (substr($file_src_name, -4) != '.txt'))
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_watermark != '' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_checked) {
                            ...
                            if (
                                (!$this->image_watermark_no_zoom_out && ($watermark_dst_width > $this->image_dst_x || $watermark_dst_height > $this->image_dst_y))
