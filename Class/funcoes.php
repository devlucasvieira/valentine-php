...
function exibe_status_contato($exibe_status_contato)
{
  switch ($exibe_status_contato) {
    case "NQ":
      return "<span class='label label-inline label-danger font-weight-bold'>Não Qualificado</span>";
      break;
    case "EA":
      return "<span class='label label-inline label-primary font-weight-bold'>Esp. Atendimento</span>";
      break;
    case "NA":
      return "<span class='label label-inline label-warning font-weight-bold'>Não Atendeu</span>";
      break;
    case "LN":
      return "<span class='label label-inline label-info font-weight-bold'>Ligar Novamente</span>";
      break;
    case "PE":
      return "<span class='label label-inline label-light-primary font-weight-bold'>Proposta Enviada</span>";
      break;
    case "I":
      return "<span class='label label-inline label-success font-weight-bold'>Interesse</span>";
      break;
    case "NF":
      return "<span class='label label-inline label-secondary font-weight-bold'>Negócio Fechado</span>";
      break;
    default:
      return "";
  }
...
function exibe_classe_indicativa($exibe_classe_indicativa)
{
  switch ($exibe_classe_indicativa) {
    case "1":
      return "<div class='btn-success btn'>L</div>";
      break;
    case "2":
      return "<div class='btn-primary btn'>10</div>";
      break;
    case "3":
      return "<div class='btn-info btn'>12</div>";
      break;
    case "4":
      return "<div class='btn-warning btn'>14</div>";
      break;
    case "5":
      return "<div class='btn-danger btn'>16</div>";
      break;
    case "6":
      return "<div class='btn-dark btn'>18</div>";
      break;
    default:
      return "";
  }
...
function exibe_ativo($exibe_ativo)
{
  switch ($exibe_ativo) {
    case "S":
      return "<a class='btn waves-effect waves-light btn-rounded btn-outline-success'>Ativo</a>";
      break;
    case "N":
      return "<a class='btn waves-effect waves-light btn-rounded btn-outline-danger'>Inativo</a>";
      break;
    default:
      return "";
  }
...
function exibe_forma_pagamento($exibe_forma_pagamento)
{
  switch ($exibe_forma_pagamento) {
    case "BO":
      ...
      break;
    case "DA":
      return "Débito em Conta Corrente";
      break;
    case "DF":
      return "Débito em Folha (Somente para Aposentados)";
      break;
    default:
      return "";
  }
...
function icone_genero_site($genero)
{
  switch ($genero) {
    case "M":
      return "images/avatars/boy.svg";
      break;
    case "F":
      return "images/avatars/girl.svg";
      break;
    default:
      return "";
  }
