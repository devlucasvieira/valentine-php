...
<head>
    ...
    <title>Painel - Configurações Aparência</title>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label  class="col-form-label">Cor 1</label>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 2</label>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 3</label>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 4</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 5</label>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 6</label>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                            <label  class="col-form-label">Cor 7</label>
