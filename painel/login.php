					...
					<div class="d-flex w-100 flex-center p-15">
						<div class="login-wrapper">
							...
							<div class="text-dark-75">
								<a href="#">
									<img src="assets/media/logos/ayzen_colorido.png" class="max-h-75px" alt="" />
								</a>
								<br> <br>
								...
								<a href="http://ayzen.com.br/" target="_blank" class="btn btn-outline-primary btn-pill py-4 px-9 font-weight-bold">Visite nosso site</a>
								<br> <br>
