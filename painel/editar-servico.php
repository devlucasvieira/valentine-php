...
<head>
    ...
    <title>Painel - Editar Serviço</title>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(isset($editaServico->sessao2_paralax) && !empty($editaServico->sessao2_paralax)){ ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                               <img src="../img/<?php echo $editaServico->sessao2_paralax;?>" width="150" alt="">
                                                </div>
                                            </div>
                                            <?php }?>
                                        </div>
                                        ...
                                        <div class="row" >
                                            ...
                                            <?php if(isset($editaServico->sessao4_paralax) && !empty($editaServico->sessao4_paralax)){ ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                               <img src="../img/<?php echo $editaServico->sessao4_paralax;?>" width="150" alt="">
                                                </div>
                                            </div>
                                            <?php }?>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Título</label>
                                                    <input type="text" class="form-control" name="contato_titulo2" value="<?php if(isset($editaServico->contato_titulo2) && !empty($editaServico->contato_titulo2)){ echo $editaServico->contato_titulo2;}?>" >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="mr-sm-2" for="">Botão</label>
                                                    <input type="text" class="form-control" name="contato_botao" value="<?php if(isset($editaServico->contato_botao) && !empty($editaServico->contato_botao)){ echo $editaServico->contato_botao;}?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
