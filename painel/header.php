            ...
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        <a href=".">
                            <b class="logo-icon">
                               <!--  <img src="assets/images/hoogli_logo.svg" alt="homepage" class="dark-logo" />
                                <img src="assets/images/hoogli_logo.svg" alt="homepage" class="light-logo" /> -->
                            </b>
                            <span class="logo-text">
                                <img src="<?php echo ASSETS_URL; ?>/painel/assets/images/ayzen_colorido.png" alt="homepage" class="dark-logo" />
                                <img src="<?php echo ASSETS_URL; ?>/painel/assets/images/ayzen_colorido.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
